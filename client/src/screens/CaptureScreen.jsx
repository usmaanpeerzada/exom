...
const EXAM_STYLES = {
  JEE:  { bg: 'bg-blue-500',    blob: 'bg-blue-400',    btn: 'bg-blue-600 shadow-blue-200',    text: 'text-blue-600',  light: 'bg-blue-50',   label: 'JEE',  emoji: '⚡', tagline: 'Find JEE Main & Advanced PYQs' },
  NEET: { bg: 'bg-emerald-500', blob: 'bg-emerald-400', btn: 'bg-emerald-600 shadow-emerald-200', text: 'text-emerald-600', light: 'bg-emerald-50', label: 'NEET', emoji: '🧬', tagline: 'Find NEET UG PYQs instantly' },
  CUET: { bg: 'bg-orange-500',  blob: 'bg-orange-400',  btn: 'bg-orange-500 shadow-orange-200',  text: 'text-orange-600', light: 'bg-orange-50',  label: 'CUET', emoji: '🎓', tagline: 'Find CUET PYQs for your subject' },
  CBSE: { bg: 'bg-violet-500',  blob: 'bg-violet-400',  btn: 'bg-violet-600 shadow-violet-200',  text: 'text-violet-600', light: 'bg-violet-50',  label: 'CBSE', emoji: '📚', tagline: 'Find CBSE board PYQs instantly' },
}
    ...
    <>
      ...
      <div className="min-h-screen flex flex-col max-w-md mx-auto">
        ...
        <div className={`relative overflow-hidden ${style.bg} px-6 pt-14 pb-10`}>
          ...
          {/* Preview card */}
          <div className="relative z-10 mt-6 bg-white/15 backdrop-blur rounded-3xl p-6 flex items-center justify-center min-h-[110px]">
        ...
        <div className="flex-1 bg-gray-50 px-5 pt-6 pb-8 flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              ...
              className={`w-full flex items-center justify-center gap-3 py-4 ${style.btn} text-white
